function [ cost ] = CtrlCost_Modified( D1,D2,L ) % Input: D1(t), D2(t), L(t)
  ...
  if(D1>MAX_DISCHARGE(1)||D2>MAX_DISCHARGE(2)||D1<0||D2<0) %||(D1+D2)>L %If control is too high or low
    ...
    cost=K*(D1/E_MAX(1))^2+(1/ALPHA_D(1)-1)*D1/E_MAX(1)+(1/ALPHA_D(2)-1)*D2/E_MAX(2)+(1-ALPHA_C(2))*(D1/E_MAX(1)+D2/E_MAX(2)-L); %Else calculate cost of control
  end
end