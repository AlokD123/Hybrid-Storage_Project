...
E_MAX=[15;5]; %Maximum energy to be stored (upper bound)
...
MAX_DISCHARGE=[15;5]; %Maximum discharging of the 1) battery and 2) supercap
            ...
            for E_Ind2=1:(E_MAX(2)-E_MIN(2)+1)
                ...
                if(D1>E1 || D2>E2)  %If discharge too high for state...
                    ...
                    for indL=1:(MAX_LOAD-MIN_LOAD+1)
                        ...
                        State_NextStates=[State_NextStates;E1,E2,D1,D2,p,L,nextE1,nextE2,boolFble];
