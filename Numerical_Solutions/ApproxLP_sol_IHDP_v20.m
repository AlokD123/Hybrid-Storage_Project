...
%%%% GET DRIVING DATA %%%%
[L_seq,Tot_E_seq] = useDrivingData(P_seq,E_norm_seq);
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%For each possible control...
  ...
  feasNextStates=[];
  for i=1:length(nextE_Ind_L_Vect)
      feasNextStates=[feasNextStates;nextE_Ind_L_Vect{i}];
  end
  uniqueFeasNextStates=unique(feasNextStates,'rows');
