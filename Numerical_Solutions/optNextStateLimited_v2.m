...
function [ nextE1,nextE2 ] = optNextStateLimited_v2( E1,E2,D1,D2,L ) % Input: state, controls, load
    global E_MIN; global BETA;
    newE1=StateEqn1_wRegenBraking(E1,D1,BETA(1));
    ...
    newE2=StateEqn2_wRegenBraking(E2,D1,D2,L,BETA(2));
    if(newE2<E_MIN(2))
