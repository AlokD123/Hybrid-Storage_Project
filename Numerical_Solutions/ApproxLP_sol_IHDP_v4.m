...
% v4: AUTOMATIC BASIS FUNCTION GENERATION (iterative), v2 (slack + extra
% constraints)
...
R=20; %MAXIMUM number of bases (MUST BE LESS THAN NUMBER OF FEASIBLE STATES)
...
%c_state=ones(size(Q,2),1);
  ...
  title('Normalized Cost Approximation Error (Default Test, 1-Norm<1e3 and Primal and NonNegCost Constraints)');
